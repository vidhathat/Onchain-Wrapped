...
export default function Loading() {
    return (
      <div className="w-[214px] h-[100px] flex-col justify-start items-center gap-6 inline-flex">
  ...
  <rect x="22.9458" y="11.4589" width="2.70754" height="8.12262" rx="1.35377" transform="rotate(-135 22.9458 11.4589)" fill="#D9D9D9"/>
    ...
    <div className="text-center text-white text-lg font-medium font-['DM Sans'] leading-snug">Looking into your txns to <br/>wrap them..</div>
  </div>
    )
  }
